...
export const DetailsMarketsData: React.FC<IProps> = ({ cryptoMarketsData, className }) => {
  ...
  return (
    <div className={'flex flex-col items-center justify-center w-full mb-16'}>
      <div className={'flex justify-between items-end w-full text-xs text-neutral-03 mb-0.5 font-medium px-6'}>
      ...
      <div
        className={'w-full py-3 text-sm font-medium text-foreground'}
      >
