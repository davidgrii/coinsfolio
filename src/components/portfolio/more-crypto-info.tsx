...
export const MoreCryptoInfo: React.FC<IProps> = ({ cryptoId }) => {
  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger>
        <Icons.marketDetails className={'w-5 h-5'} />
      </AlertDialogTrigger>
      ...
      <AlertDialogContent className={'max-w-80 -mr-5 pl-5'}>
        ...
        <AlertDialogFooter>
          <AlertDialogCancel
            className={
              'bg-[#1C1C1E] border-0 text-foreground w-20 h-9 hover:bg-card focus-visible:ring-0 focus-visible:ring-offset-0 active:border-0 hover:text-foreground rounded-lg'
            }
          >
          ...
          <AlertDialogAction
            className={
              'bg-[#007BFF] border-0 w-28 h-9 text-foreground rounded-lg hover:bg-[#007BFF]/80'
            }
          >
            <Link
