  ...
  return (
    <>
      <Modal
        ...
        header={<ModalHeader />}
        className='!bg-base-background !h-dvh !min-h-max !z-50 shadow-[0_0_0_2px_rgba(255,255,255,0.1)]'
      >
        <VisuallyHidden>
          <DialogTitle>Edit Portfolio Modal</DialogTitle>
        </VisuallyHidden>
        ...
        >
          {selectedCrypto && (
            <div
              className={cn(
                'relative flex items-center justify-between w-full px-3 py-4 h-[50px] !bg-neutral-04 rounded-xl',
              ...
              after={
                quantity ? (
                  ...
                  <Icons.question
                    onClick={() =>
                      alert(
                        'Enter your total crypto quantity Example: 123,450.32 or 0.00213',
                      )
                    }
              ...
              after={
                purchase ? (
                  ...
                  <Icons.question
                    onClick={() =>
                      alert(
                        'Enter your crypto purchase price Example: 123,450.32 or 0.00213',
                      )
                    }
                    className='size-5 mr-0.5 text-neutral-03 cursor-pointer duration-200 transition-opacity ease-out hover:opacity-80'
                  />
