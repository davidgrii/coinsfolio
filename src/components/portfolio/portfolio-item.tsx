          ...
          <CardContent className={'p-0 flex w-full justify-between select-none'}>
            <div className={'flex items-center gap-2'}>
              <div className="rounded-full overflow-hidden">
                <Avatar size={40} src={item.crypto.image} alt={item.crypto.name} className="!bg-transparent" />
              </div>
            ...
            <div className={'flex items-center'}>
              <div className={'mr-4'}>
                ...
                <p
                  className={`${item.crypto.price_change_percentage_24h.toString().includes('-')
                    ...
                    : 'text-specials-success'}  text-[8.7px] text-right font-semibold`}
                >
              ...
              <div className={'w-24 mr-6'}>
                ...
                <p
                  className={'text-neutral-03 text-[8.7px] text-right font-semibold'}
                >
